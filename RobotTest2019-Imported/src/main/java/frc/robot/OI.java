/*Joshua: OI stands for operator input. It has anything to do with buttons or
controls of any type. You declare all the button objects and variables here so 
that they can be accessed in the Robot file */
